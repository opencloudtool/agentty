...
Design and architecture guides for the `docs` section under
`/docs/architecture/`.
...
- [testability-boundaries.md](testability-boundaries.md) - Trait boundaries and guidance for deterministic tests.
