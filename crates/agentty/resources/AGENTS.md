...
- [`protocol_instruction_prompt.md`](protocol_instruction_prompt.md) - Prompt template that prepends repository-root-relative file path rules plus the structured response protocol and full self-descriptive JSON schema block.
