...
- [`query-422bcf5129f03b6058bd1e5a04d376caa763c5084bd499abe763bfb2e655ce7a.json`](query-422bcf5129f03b6058bd1e5a04d376caa763c5084bd499abe763bfb2e655ce7a.json) - Metadata for listing projects with aggregated session counts and latest session updates via the `stats` CTE.
