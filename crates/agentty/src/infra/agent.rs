...
pub(crate) use backend::{
    ProtocolInstructionMode, ProtocolPromptKind, build_command_stdin_payload, build_resume_prompt,
    parse_stream_output_line, prepend_protocol_instructions, prepend_repo_root_path_instructions,
};
