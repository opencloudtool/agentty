...
mod tests {
    ...
    #[tokio::test]
    async fn test_find_git_repo_exists() {
        // Arrange
    ...
    #[tokio::test]
    async fn test_find_git_repo_not_exists() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
    ...
    #[tokio::test]
    async fn test_find_git_repo_parent() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let git_dir = dir.path().join(".git");
        fs::create_dir(&git_dir).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_get_git_branch_normal() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let git_dir = dir.path().join(".git");
        fs::create_dir(&git_dir).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_get_git_branch_detached() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let git_dir = dir.path().join(".git");
        fs::create_dir(&git_dir).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_get_git_branch_invalid() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let git_dir = dir.path().join(".git");
        fs::create_dir(&git_dir).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_get_git_branch_worktree_git_file() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
    ...
    #[tokio::test]
    async fn test_detect_git_info_full_flow() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let git_dir = dir.path().join(".git");
        fs::create_dir(&git_dir).expect("test setup failed");
        ...
        // Act
        let result = detect_git_info(dir.path().to_path_buf()).await;
    ...
    #[tokio::test]
    async fn test_detect_git_info_worktree_git_file() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let worktree_path = dir.path().join("worktree");
        fs::create_dir(&worktree_path).expect("test setup failed");
        ...
        // Act
        let result = detect_git_info(worktree_path).await;
    ...
    #[tokio::test]
    async fn test_detect_git_info_no_repo() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
    ...
    #[tokio::test]
    async fn test_find_git_repo_root() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let git_dir = dir.path().join(".git");
        fs::create_dir(&git_dir).expect("test setup failed");
        ...
        // Act
        let result = find_git_repo_root(dir.path().to_path_buf()).await;
    ...
    #[tokio::test]
    async fn test_find_git_repo_root_with_git_file() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        fs::write(
            dir.path().join(".git"),
    ...
    #[tokio::test]
    async fn test_create_worktree_invalid_repo() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let worktree_path = dir.path().join("worktree");
        let branch_name = "agentty/test123";
    ...
    async fn test_remove_worktree_success() {
        ...
        // Act
        let result = remove_worktree(worktree_path.clone()).await;
    ...
    async fn test_delete_branch_success() {
        ...
        // Act
        let result = delete_branch(dir.path().to_path_buf(), branch_name.to_string()).await;
    ...
    #[tokio::test]
    async fn test_remove_worktree_not_exists() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        let worktree_path = dir.path().join("nonexistent");

        // Act
        let result = remove_worktree(worktree_path).await;
    ...
    #[tokio::test]
    async fn test_squash_merge_diff_success() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
    ...
    #[tokio::test]
    async fn test_squash_merge_diff_invalid_branch() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_squash_merge_success() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_squash_merge_no_changes() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_squash_merge_changes_already_in_base() {
    ...
    #[tokio::test]
    async fn test_squash_merge_invalid_source_branch() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_squash_merge_wrong_branch() {
    ...
    async fn test_rebase_success() {
        ...
        // Act
        let result = rebase(dir.path().to_path_buf(), "main".to_string()).await;
    ...
    #[tokio::test]
    async fn test_rebase_conflict_aborts_in_progress_state() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
    ...
    #[tokio::test]
    async fn test_rebase_start_conflict_keeps_rebase_in_progress() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
        ...
        // Act
        let result = rebase_start(dir.path().to_path_buf(), "main".to_string()).await;
    ...
    #[tokio::test]
    async fn test_list_conflicted_files_and_unmerged_paths_on_rebase_conflict() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
        ...
        Command::new("git")
            ...
            .output()
            .expect("test setup failed");
        let rebase_result = rebase_start(dir.path().to_path_buf(), "main".to_string()).await;
        assert!(matches!(
            rebase_result,
        ...
        // Act
        let conflicted_files = list_conflicted_files(dir.path().to_path_buf())
            .await
            .expect("should list conflicts");
        let has_unmerged = has_unmerged_paths(dir.path().to_path_buf())
            .await
            .expect("should query unmerged paths");
    ...
    #[tokio::test]
    async fn test_rebase_continue_conflict_when_unmerged_paths_remain() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
        ...
        // Act
        let continue_result = rebase_continue(dir.path().to_path_buf()).await;
    ...
    #[tokio::test]
    async fn test_rebase_continue_succeeds_with_non_interactive_editor() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
        ...
        let in_progress = is_rebase_in_progress(dir.path().to_path_buf())
            .await
            .expect("should query rebase state");
        assert!(!in_progress, "rebase should be completed");
    }

    #[tokio::test]
    async fn test_is_rebase_in_progress_false_when_no_rebase_exists() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");

        // Act
        let is_rebase_in_progress_result = is_rebase_in_progress(dir.path().to_path_buf()).await;
    ...
    #[tokio::test]
    async fn test_is_rebase_in_progress_true_during_conflict() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        Command::new("git")
    ...
    #[tokio::test]
    async fn test_stage_all_stages_changed_files() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
        ...
        // Act
        let stage_result = stage_all(dir.path().to_path_buf()).await;
    ...
    #[tokio::test]
    async fn test_commit_all_no_changes() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");

        // Act - no changes to commit
        let result = commit_all(dir.path().to_path_buf(), "Empty commit".to_string(), false).await;
    ...
    #[tokio::test]
    async fn test_commit_all_retries_when_hook_modifies_files() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
...
"#,
        ...
        let result = commit_all(
            dir.path().to_path_buf(),
            "Retry commit message".to_string(),
            false,
        )
        .await;
    ...
    #[tokio::test]
    async fn test_commit_all_returns_error_when_hook_keeps_modifying_files() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
...
"#,
    ...
    #[tokio::test]
    async fn test_head_short_hash_returns_current_commit_hash() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");

        // Act
        let result = head_short_hash(dir.path().to_path_buf()).await;
    ...
    async fn test_diff_success() {
        ...
        // Act
        let result = diff(dir.path().to_path_buf(), "HEAD".to_string()).await;
    ...
    #[tokio::test]
    async fn test_diff_includes_untracked_files() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_diff_includes_deleted_files() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");
        setup_test_git_repo(dir.path()).expect("test setup failed");
    ...
    #[tokio::test]
    async fn test_repo_url_invalid_repo() {
        // Arrange
        let dir = tempdir().expect("failed to create temp dir");

        // Act
        let result = repo_url(dir.path().to_path_buf()).await;
